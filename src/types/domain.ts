...
export interface IdeaRecord { id: string; spaceId: string; title: string; category: string; categoryEmoji: string; accent: string; description: string; location: string; tags: string[]; photoUrl: string; createdBy: string; createdByName: string; completed: boolean; questType?: QuestType; status?: QuestStatus; collectionId?: string | null; parentQuestId?: string | null; relatedQuestIds?: string[]; goalTarget?: number | null; goalCurrent?: number | null; goalUnit?: string; templateId?: IdeaTemplateId; templateVersion?: number; templateData?: IdeaTemplateData; starterId?: string; completedAt?: Timestamp | null; createdAt?: Timestamp; updatedAt?: Timestamp; }
