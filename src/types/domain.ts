...
export interface IdeaRecord { id: string; spaceId: string; title: string; category: string; categoryEmoji: string; accent: string; description: string; location: string; tags: string[]; photoUrl: string; createdBy: string; createdByName: string; completed: boolean; questType?: QuestType; status?: QuestStatus; collectionId?: string | null; templateId?: IdeaTemplateId; templateVersion?: number; templateData?: IdeaTemplateData; starterId?: string; completedAt?: Timestamp | null; createdAt?: Timestamp; updatedAt?: Timestamp; }
