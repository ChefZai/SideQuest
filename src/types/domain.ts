...
export interface ActivityRecord { id: string; spaceId: string; actorId: string; actorName: string; action: string; targetId: string; targetTitle: string; questId?: string; momentType?: MomentType; title?: string; description?: string; imageUrl?: string; location?: string; people?: string[]; reactionCount?: number; isMilestone?: boolean; emoji?: string; celebrationColor?: string; createdAt?: Timestamp; }
